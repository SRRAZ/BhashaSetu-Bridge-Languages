...
public final class WordDao_WordDatabase_Impl implements WordDao {
  ...
  public WordDao_WordDatabase_Impl(@NonNull final RoomDatabase __db) {
    this.__db = __db;
  ...
  @Override
  public LiveData<List<Word>> getWordsForLesson(final long lessonId) {
    final String _sql = "SELECT w.* FROM words w INNER JOIN lesson_words lw ON w.id = lw.wordId WHERE lw.lessonId = ? ORDER BY lw.orderInLesson ASC";
