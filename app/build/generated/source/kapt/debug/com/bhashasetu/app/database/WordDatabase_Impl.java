...
public final class WordDatabase_Impl extends WordDatabase {
  ...
  private volatile GamificationAchievementDao _gamificationAchievementDao;
  ...
  protected RoomOpenDelegate createOpenDelegate() {
    final RoomOpenDelegate _openDelegate = new RoomOpenDelegate(1, "208dbf2216247af3f0781da2f486c7c6", "053bd1bb876e062353768b10ac379bea") {
      @Override
      public void createAllTables(@NonNull final SQLiteConnection connection) {
        ...
        SQLite.execSQL(connection, "CREATE TABLE IF NOT EXISTS `legacy_achievements` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `title` TEXT, `description` TEXT, `type` TEXT, `iconResId` INTEGER NOT NULL, `pointsValue` INTEGER NOT NULL, `unlocked` INTEGER NOT NULL, `dateUnlocked` INTEGER NOT NULL, `progressCurrent` INTEGER NOT NULL, `progressTarget` INTEGER NOT NULL, `secret` INTEGER NOT NULL)");
        SQLite.execSQL(connection, "CREATE TABLE IF NOT EXISTS `badges` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `name` TEXT, `description` TEXT, `tier` TEXT, `imagePath` TEXT, `earned` INTEGER NOT NULL, `earnedAt` INTEGER, `achievementId` INTEGER NOT NULL)");
        ...
        SQLite.execSQL(connection, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '208dbf2216247af3f0781da2f486c7c6')");
      }
      ...
      public RoomOpenDelegate.ValidationResult onValidateSchema(
        ...
        final Map<String, TableInfo.Column> _columnsLegacyAchievements = new HashMap<String, TableInfo.Column>(11);
        ...
        _columnsLegacyAchievements.put("dateUnlocked", new TableInfo.Column("dateUnlocked", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsLegacyAchievements.put("progressCurrent", new TableInfo.Column("progressCurrent", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsLegacyAchievements.put("secret", new TableInfo.Column("secret", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        final Map<String, TableInfo.Column> _columnsBadges = new HashMap<String, TableInfo.Column>(8);
  ...
  protected Map<Class<?>, List<Class<?>>> getRequiredTypeConverters() {
    ...
    _typeConvertersMap.put(GamificationAchievementDao.class, GamificationAchievementDao_Impl.getRequiredConverters());
    _typeConvertersMap.put(BadgeDao.class, BadgeDao_Impl.getRequiredConverters());
    _typeConvertersMap.put(UserPointsDao.class, UserPointsDao_Impl.getRequiredConverters());
    _typeConvertersMap.put(UserLevelDao.class, UserLevelDao_Impl.getRequiredConverters());
  ...
  @Override
  public GamificationAchievementDao gamificationAchievementDao() {
    if (_gamificationAchievementDao != null) {
      return _gamificationAchievementDao;
    } else {
      synchronized(this) {
        if(_gamificationAchievementDao == null) {
          _gamificationAchievementDao = new GamificationAchievementDao_Impl(this);
        }
        return _gamificationAchievementDao;
      }
    }
  ...
  public UserPointsDao userPointsDao() {
    if (_userPointsDao != null) {
      ...
      synchronized(this) {
        if(_userPointsDao == null) {
          _userPointsDao = new UserPointsDao_Impl(this);
        }
        return _userPointsDao;
      }
    }
  ...
  public UserLevelDao userLevelDao() {
    if (_userLevelDao != null) {
      ...
      synchronized(this) {
        if(_userLevelDao == null) {
          _userLevelDao = new UserLevelDao_Impl(this);
        }
        return _userLevelDao;
      }
    }
