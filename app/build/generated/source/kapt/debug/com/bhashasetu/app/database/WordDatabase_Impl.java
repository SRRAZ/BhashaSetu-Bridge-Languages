...
public final class WordDatabase_Impl extends WordDatabase {
  ...
  protected RoomOpenDelegate createOpenDelegate() {
    final RoomOpenDelegate _openDelegate = new RoomOpenDelegate(1, "afd1f76dacf3c935f37b3fff035a8018", "90f8ec357b2235a4e049bbcc2734e817") {
      @Override
      public void createAllTables(@NonNull final SQLiteConnection connection) {
        ...
        SQLite.execSQL(connection, "CREATE TABLE IF NOT EXISTS `legacy_achievements` (`id` TEXT NOT NULL, `title` TEXT, `description` TEXT, `type` TEXT, `iconResId` INTEGER NOT NULL, `pointsValue` INTEGER NOT NULL, `unlocked` INTEGER NOT NULL, `dateUnlocked` INTEGER NOT NULL, `progressCurrent` INTEGER NOT NULL, `progressTarget` INTEGER NOT NULL, `secret` INTEGER NOT NULL, PRIMARY KEY(`id`))");
        ...
        SQLite.execSQL(connection, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'afd1f76dacf3c935f37b3fff035a8018')");
      }
      ...
      public RoomOpenDelegate.ValidationResult onValidateSchema(
        ...
        _columnsLegacyAchievements.put("id", new TableInfo.Column("id", "TEXT", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
