...
public final class LessonDao_AppDatabase_0_Impl implements LessonDao {
  ...
  public LessonDao_AppDatabase_0_Impl(@NonNull final RoomDatabase __db) {
    this.__db = __db;
    ...
    return DBUtil.performSuspending(__db, true, true, (_connection) -> {
      ...
      try {
        ...
        while (_stmt.step()) {
          ...
          if (!_collectionLessonWords.containsKey(_tmpKey)) {
            _collectionLessonWords.put(_tmpKey, new ArrayList<LessonWord>());
          }
        }
        _stmt.reset();
        ...
        if (_stmt.step()) {
          ...
          _tmpLessonWordsCollection = _collectionLessonWords.get(_tmpKey_1);
          _result = new LessonWithWords(_tmpLesson,null,_tmpLessonWordsCollection);
        } else {
          _result = null;
        }
        return _result;
  ...
  public Flow<LessonWithWords> getLessonWithWordsFlow(final long lessonId) {
    final String _sql = "SELECT * FROM lessons WHERE id = ?";
    return FlowUtil.createFlow(__db, true, new String[] {"lesson_words",
        "lessons"}, (_connection) -> {
      final SQLiteStatement _stmt = _connection.prepare(_sql);
      try {
        int _argIndex = 1;
    ...
    return FlowUtil.createFlow(__db, true, new String[] {"lesson_words",
      ...
      try {
        ...
        while (_stmt.step()) {
          ...
          _tmpKey_1 = _stmt.getLong(_columnIndexOfId);
          _tmpLessonWordsCollection = _collectionLessonWords.get(_tmpKey_1);
          _item = new LessonWithWords(_tmpLesson,null,_tmpLessonWordsCollection);
          _result.add(_item);
        }
        return _result;
      } finally {
    ...
    try {
      ...
      while (_stmt.step()) {
        ...
        if (_tmpRelation != null) {
          ...
          _tmpWordId = (int) (_stmt.getLong(_columnIndexOfWordId));
