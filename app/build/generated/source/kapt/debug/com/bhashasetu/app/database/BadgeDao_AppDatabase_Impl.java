...
public final class BadgeDao_AppDatabase_Impl implements BadgeDao {
  ...
  public BadgeDao_AppDatabase_Impl(@NonNull final RoomDatabase __db) {
    this.__db = __db;
    this.__insertAdapterOfBadge = new EntityInsertAdapter<Badge>() {
      @Override
      @NonNull
      protected String createQuery() {
        return "INSERT OR ABORT INTO `badges` (`id`,`name`,`description`,`tier`,`imagePath`,`earned`,`earnedAt`,`pointsRequired`,`achievementId`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SQLiteStatement statement, final Badge entity) {
        ...
        if (entity.getTier() == null) {
          ...
          statement.bindText(4, __BadgeTier_enumToString(entity.getTier()));
        }
        ...
        statement.bindLong(8, entity.getPointsRequired());
        statement.bindLong(9, entity.getAchievementId());
      }
    };
    this.__updateAdapterOfBadge = new EntityDeleteOrUpdateAdapter<Badge>() {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `badges` SET `id` = ?,`name` = ?,`description` = ?,`tier` = ?,`imagePath` = ?,`earned` = ?,`earnedAt` = ?,`pointsRequired` = ?,`achievementId` = ? WHERE `id` = ?";
      }
  ...
  public LiveData<List<Badge>> getAllBadges() {
    ...
    return __db.getInvalidationTracker().createLiveData(new String[] {"badges"}, false, (_connection) -> {
      ...
      try {
        ...
        final int _columnIndexOfPointsRequired = SQLiteStatementUtil.getColumnIndexOrThrow(_stmt, "pointsRequired");
        ...
        while (_stmt.step()) {
          ...
          if (_stmt.isNull(_columnIndexOfTier)) {
            ...
            _tmpTier = __BadgeTier_stringToEnum(_stmt.getText(_columnIndexOfTier));
          }
          ...
          final int _tmp;
          _tmp = (int) (_stmt.getLong(_columnIndexOfEarned));
          _tmpEarned = _tmp != 0;
          ...
          _tmpPointsRequired = (int) (_stmt.getLong(_columnIndexOfPointsRequired));
    ...
    return __db.getInvalidationTracker().createLiveData(new String[] {"badges"}, false, (_connection) -> {
      ...
      try {
        ...
        if (_stmt.step()) {
          ...
          final int _tmpPointsRequired;
          _tmpPointsRequired = (int) (_stmt.getLong(_columnIndexOfPointsRequired));
          _result.setPointsRequired(_tmpPointsRequired);
          final int _tmpAchievementId;
          _tmpAchievementId = (int) (_stmt.getLong(_columnIndexOfAchievementId));
    ...
    return __db.getInvalidationTracker().createLiveData(new String[] {"badges"}, false, (_connection) -> {
      ...
      try {
        ...
        if (tier == null) {
          ...
          _stmt.bindText(_argIndex, __BadgeTier_enumToString(tier));
        }
        final int _columnIndexOfId = SQLiteStatementUtil.getColumnIndexOrThrow(_stmt, "id");
        final int _columnIndexOfName = SQLiteStatementUtil.getColumnIndexOrThrow(_stmt, "name");
        final int _columnIndexOfDescription = SQLiteStatementUtil.getColumnIndexOrThrow(_stmt, "description");
  ...
  private String __BadgeTier_enumToString(@NonNull final BadgeTier _value) {
    switch (_value) {
  ...
  private BadgeTier __BadgeTier_stringToEnum(@NonNull final String _value) {
    switch (_value) {
      case "BRONZE": return BadgeTier.BRONZE;
      case "SILVER": return BadgeTier.SILVER;
      case "GOLD": return BadgeTier.GOLD;
      case "PLATINUM": return BadgeTier.PLATINUM;
      case "DIAMOND": return BadgeTier.DIAMOND;
