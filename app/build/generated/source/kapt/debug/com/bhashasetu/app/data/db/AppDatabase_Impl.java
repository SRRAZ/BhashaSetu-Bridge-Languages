...
public final class AppDatabase_Impl extends AppDatabase {
  ...
  protected RoomOpenDelegate createOpenDelegate() {
    final RoomOpenDelegate _openDelegate = new RoomOpenDelegate(2, "4e7efe1791c1312e5163b7452ccd96f1", "e2f9f51aaa51e927c5ddeef8870cc28a") {
      @Override
      public void createAllTables(@NonNull final SQLiteConnection connection) {
        ...
        SQLite.execSQL(connection, "CREATE TABLE IF NOT EXISTS `user_goals` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `title` TEXT NOT NULL, `description` TEXT, `goalType` TEXT NOT NULL, `targetValue` INTEGER NOT NULL, `currentValue` INTEGER NOT NULL, `progress` INTEGER NOT NULL, `categoryId` INTEGER, `periodType` TEXT NOT NULL, `startDate` INTEGER NOT NULL, `endDate` INTEGER, `targetDate` INTEGER, `repeatDaily` INTEGER NOT NULL, `reminderEnabled` INTEGER NOT NULL, `reminderTime` TEXT, `isCompleted` INTEGER NOT NULL, `completed` INTEGER NOT NULL, `completedAt` INTEGER, `completedDate` INTEGER, `isActive` INTEGER NOT NULL, `createdAt` INTEGER NOT NULL, `lastUpdatedAt` INTEGER NOT NULL, FOREIGN KEY(`categoryId`) REFERENCES `categories`(`id`) ON UPDATE NO ACTION ON DELETE SET NULL )");
        ...
        SQLite.execSQL(connection, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '4e7efe1791c1312e5163b7452ccd96f1')");
      }
      ...
      public RoomOpenDelegate.ValidationResult onValidateSchema(
        ...
        final Map<String, TableInfo.Column> _columnsUserGoals = new HashMap<String, TableInfo.Column>(22);
        ...
        _columnsUserGoals.put("progress", new TableInfo.Column("progress", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsUserGoals.put("targetDate", new TableInfo.Column("targetDate", "INTEGER", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsUserGoals.put("isCompleted", new TableInfo.Column("isCompleted", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsUserGoals.put("completedDate", new TableInfo.Column("completedDate", "INTEGER", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
