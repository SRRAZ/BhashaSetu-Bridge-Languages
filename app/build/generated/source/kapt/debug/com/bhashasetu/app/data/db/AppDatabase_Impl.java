...
import com.bhashasetu.app.data.dao.LessonDao_AppDatabase_1_Impl;
...
import com.bhashasetu.app.data.dao.UserGoalDao_AppDatabase_1_Impl;
...
public final class AppDatabase_Impl extends AppDatabase {
  ...
  protected RoomOpenDelegate createOpenDelegate() {
    final RoomOpenDelegate _openDelegate = new RoomOpenDelegate(2, "1a36a8f9b370cd3d14d30c3d00d62225", "813e16fc45d3ac1d9affdc6760989d0e") {
      @Override
  ...
  protected Map<Class<?>, List<Class<?>>> getRequiredTypeConverters() {
    ...
    _typeConvertersMap.put(LessonDao.class, LessonDao_AppDatabase_1_Impl.getRequiredConverters());
    ...
    _typeConvertersMap.put(UserGoalDao.class, UserGoalDao_AppDatabase_1_Impl.getRequiredConverters());
  ...
  public LessonDao lessonDao() {
    if (_lessonDao != null) {
      ...
      synchronized(this) {
        if(_lessonDao == null) {
          _lessonDao = new LessonDao_AppDatabase_1_Impl(this);
        }
        return _lessonDao;
      }
    }
  ...
  public UserGoalDao userGoalDao() {
    if (_userGoalDao != null) {
      ...
      synchronized(this) {
        if(_userGoalDao == null) {
          _userGoalDao = new UserGoalDao_AppDatabase_1_Impl(this);
        }
        return _userGoalDao;
      }
    }
