 ...
 */
public class AudioUtilManager {
    
    private static final String TAG = "AppAudioManager";
    
    private static AudioUtilManager instance;
    ...
    private AudioUtilManager(Context context) {
        this.context = context.getApplicationContext();
        this.audioCache = new HashMap<>();
        initializeMediaPlayer();
    }
    
    public static synchronized AudioUtilManager getInstance(Context context) {
        if (instance == null) {
            instance = new AudioUtilManager(context);
        }
        return instance;
    }
